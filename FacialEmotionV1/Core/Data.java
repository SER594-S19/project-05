...
public class Data {
  ...
  public String toString() {
    return "Data{" + "timestamp="+time+ ", agreement="+agreement+", concentrating="+concentrating+", disagreement="+disagreement+", interested="+interested+", thinking="+thinking+", unsure="+unsure+'}';
  }
